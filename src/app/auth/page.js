    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        @keyframes slide-car{0%{transform:translateX(110vw)}100%{transform:translateX(-20vw)}}
        ...
        .road-divider{
          ...
          background:repeating-linear-gradient(
            180deg,
            rgba(255,90,20,.6) 0px,rgba(255,90,20,.6) 30px,
        ...
        .city{
          ...
          background:
            ...
            /* building shapes via repeating */
            repeating-linear-gradient(90deg,
              #0d0f18 0px, #0d0f18 18px,
              transparent 18px, transparent 22px,
              #0d0f18 22px, #0d0f18 48px,
              transparent 48px, transparent 52px,
              #0d0f18 52px, #0d0f18 62px,
              transparent 62px, transparent 66px,
              #0d0f18 66px, #0d0f18 90px,
              transparent 90px, transparent 95px,
              #0d0f18 95px, #0d0f18 110px,
        ...
        .glow-red{
          ...
          background:radial-gradient(ellipse,rgba(220,40,20,.18) 0%,transparent 70%);
          bottom:28%;left:-100px;
          pointer-events:none;
        }
        .glow-orange{
          position:absolute;
          width:400px;height:200px;
          background:radial-gradient(ellipse,rgba(255,100,10,.12) 0%,transparent 70%);
          bottom:32%;right:0;
          pointer-events:none;
        }
        .glow-top{
          ...
          background:radial-gradient(ellipse,rgba(180,20,10,.08) 0%,transparent 70%);
        ...
        .race-car{
          ...
          filter:drop-shadow(0 0 30px rgba(230,50,10,.55)) drop-shadow(0 0 8px rgba(255,100,20,.4));
        }
        ...
        .card{
          ...
          border:1px solid rgba(220,60,10,.28);
          border-radius:24px;
          padding:2.2rem 2rem;
          backdrop-filter:blur(24px);
          animation:fadeUp .6s cubic-bezier(.16,1,.3,1) both;
          box-shadow:
            0 0 0 1px rgba(220,60,10,.1),
            0 20px 60px rgba(0,0,0,.6),
            inset 0 1px 0 rgba(255,100,30,.12);
        }
        ...
        .brand-icon{
          ...
          background:linear-gradient(135deg,#e53e1a,#ff6b1a);
          border-radius:10px;
          display:flex;align-items:center;justify-content:center;
          font-size:1.2rem;
          box-shadow:0 0 16px rgba(229,62,26,.5);
          flex-shrink:0;
        }
        .brand-name{
          font-family:'Sora',sans-serif;
          font-size:1.1rem;font-weight:800;
          background:linear-gradient(90deg,#ff6b1a,#ffd54f);
        ...
        .tabs{
          ...
          border:1px solid rgba(220,60,10,.15);
          border-radius:12px;padding:3px;margin-bottom:1.6rem;gap:3px;
        }
        .tab{
          flex:1;padding:.55rem;border:none;border-radius:9px;
          font-family:'Tajawal',sans-serif;font-size:.9rem;font-weight:500;
          cursor:pointer;transition:all .22s;background:transparent;color:rgba(255,255,255,.3);
        }
        .tab.on{
          background:linear-gradient(135deg,#c0330f,#e53e1a);
          color:#fff;font-weight:700;
          box-shadow:0 3px 14px rgba(229,62,26,.45);
        }
        ...
        .inp{
          width:100%;padding:.78rem 2.4rem .78rem .9rem;
        ...
        .inp:focus{
          border-color:#e53e1a;
          background:rgba(229,62,26,.08);
          box-shadow:0 0 0 3px rgba(229,62,26,.15);
        }
        ...
        .role-btn{
          padding:.65rem .5rem;border-radius:11px;
          border:1.5px solid rgba(255,255,255,.08);
          background:rgba(255,255,255,.04);
          color:rgba(255,255,255,.45);
          font-family:'Tajawal',sans-serif;font-size:.87rem;font-weight:500;
          cursor:pointer;transition:all .2s;text-align:center;
        }
        .role-btn.sel{
          background:rgba(229,62,26,.15);
          border-color:rgba(229,62,26,.5);
          color:#ff8a5b;font-weight:700;
        }

        /* Submit button */
        .btn-sub{
          margin-top:.25rem;padding:.88rem;
          background:linear-gradient(135deg,#c0330f 0%,#e53e1a 50%,#ff5a20 100%);
          ...
          box-shadow:0 4px 22px rgba(229,62,26,.5);width:100%;
          display:flex;align-items:center;justify-content:center;gap:.5rem;
          letter-spacing:.02em;
        }
        .btn-sub:hover:not(:disabled){
          transform:translateY(-2px);
          box-shadow:0 8px 28px rgba(229,62,26,.65);
        }
        ...
        /* Speed stripes decoration on card edges */
        .stripe-deco{
      ...
      <div className="bg-scene" aria-hidden="true">
        ...
        <div className="car-wrap">
          <svg className="race-car" viewBox="0 0 520 180" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* F1-style nose cone */}
            <path d="M80 132 Q60 130 40 128 Q28 127 25 132 Q28 138 50 138 L80 138 Z"
              fill="#9b2d0c"/>
            ...
            {/* Brake disc glow front */}
            <ellipse cx="140" cy="150" rx="12" ry="8" fill="rgba(255,120,20,.12)"/>
            {/* Brake disc glow rear */}
            <ellipse cx="380" cy="150" rx="13" ry="9" fill="rgba(255,120,20,.1)"/>

            {/* Exhaust glow */}
            <ellipse cx="490" cy="132" rx="10" ry="6" fill="rgba(255,80,10,.3)"/>
            <ellipse cx="498" cy="132" rx="6" ry="4" fill="rgba(255,160,30,.4)"/>
            ...
            {/* Tail lights */}
            <ellipse cx="482" cy="122" rx="7" ry="5" fill="#ff1a00" opacity=".9"/>
            <ellipse cx="482" cy="122" rx="4" ry="3" fill="#ff6060" opacity=".95"/>

            {/* Front wheel axle detail */}
            <rect x="108" y="148" width="32" height="4" rx="2" fill="#333"/>
            {/* Rear wheel axle */}
            <rect x="346" y="149" width="34" height="4" rx="2" fill="#333"/>

            {/* Side pod cooling fins */}
